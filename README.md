...
usage: pally.py [-h] [-d] [--skip-plot] [-o OUTPUT]
                ...
                [-yuv] [-e] [-t TEST_IMAGE] [-r RENDER_IMG] [-w] [-p]
                ...
                [-vss V_SUBCARRIER_SHIFT] [-bse] [-spg] [-phs PHASE_SKEW]
                [-phd PHASE_DISTORTION] [-aps ANTIEMPHASIS_PHASE_SKEW]
...
options:
  ...
  -yuv, --yuv-format    Store color information in raw Y, b-y, and r-y (YUV)
                        triplet values instead of RGB. Disables colorimetry
                        and normalization.
  ...
  -axs {None,CXA2025AS_JP,CXA2025AS_US,bisqwit_NTSC_1953}, --axis-shift {None,CXA2025AS_JP,CXA2025AS_US,bisqwit_NTSC_1953}
                        ...
                        default = None
  -vss V_SUBCARRIER_SHIFT, --v-subcarrier-shift V_SUBCARRIER_SHIFT
                        Additional V subcarrier offset phase shift, in
                        degrees, default = 0.0
